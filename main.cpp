...
int main(int, char**)
{
    ...
    while (!done)
    {
        ...
        // 2. Show a simple window that we create ourselves. We use a Begin/End pair to create a named window.
        {
            ...
            ImGui::Checkbox("Cut white", &filter.cutWhite);
            ImGui::Checkbox("Cut blue", &(filter.cutBlue));
            ImGui::Checkbox("Isolate green", &filter.isoGreen);
            ImGui::Checkbox("Cut red", &filter.cutRed);
            ...
            ImGui::SliderInt("Green upper threshold", &filter.greenUpperThreshold, 0, 255);
            ImGui::SliderInt("Green lower threshold", &filter.greenLowerThreshold, 0, 255);
            ImGui::SliderInt("Red upper threshold", &filter.redUpperThreshold, 0, 255);
            ImGui::SliderInt("Red lower threshold", &filter.redLowerThreshold, 0, 255);
            ImGui::SliderInt("White upper threshold", &filter.whiteUpperThreshold, 0, 255);
            ImGui::SliderInt("White lower threshold", &filter.whiteLowerThreshold, 0, 255);

            ImGui::SliderInt("Blur kernel width", &filter.blurKernelY, 1, 255);
            ImGui::SliderInt("Blur kernel height", &filter.blurKernelX, 1, 255);
            ImGui::SliderInt("Edges lower threshold", &filter.edgesLowerThreshold, 0, 255);
            ImGui::SliderInt("Edges upper threshold", &filter.edgesUpperThreshold, 0, 255);

            ImGui::SliderInt("Isolate hue lower threshold", &filter.isoHueLower, 0, 255);
